...
class ContenedorMongo {
  ...
  async guardarEnCarrito(idCart, elemento) {
    ...
    if (tempCart) {
      ...
      resultado = "El producto fue agregado en el carrito exitosamente";
    } else {
      resultado = "ID del carrito no existente";
    }
    return resultado;
  }
  ...
  async borrarDelCarrito(idCart, idProduct) {
    ...
    if (tempCart) {
      ...
      if (indiceEncontrado >= 0) {
        ...
        resultado = "El carrito se encuentra pero el producto no existe";
      }
    } else {
